...
int main() 
{
    ...
    std::cout << "Values a1= " << a1 << std::endl; 
    std::cout << "Values a2= " << a2 << std::endl; 
    std::cout << "Values a3= " << a3 << std::endl; 
    std::cout << "Values a4= " << a4 << std::endl; 
    std::cout << "Values a5= " << a5 << std::endl; 
    std::cout << "Values a6= " << a6 << std::endl; 
