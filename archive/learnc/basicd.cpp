...
int main()
{
    ...
    std::cout << "Enter a distance as yards, feet, and inches "
              << "with the 3 values separated by spaces:" << std::endl;
    ...
    inches = total_inches % feet_per_yard;
    std::cout << "The distances corresponds to " << yards << " yards " << feet << " feet " << inches << " inches."
              << std::endl;
